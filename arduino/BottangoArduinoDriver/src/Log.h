...
#define PRINT(msg) BottangoCore::serial.print(msg);
#define PRINT_LN(msg)  \
    BottangoCore::serial.print(msg); \
    BottangoCore::serial.print("\n");
#define PRINT_NEWLINE() BottangoCore::serial.print("\n");
#define PRINT_INT(i)               \
    sprintf(buffer, "%d", (int)i); \
    BottangoCore::serial.print(buffer);
